...
def main() -> int:
    ...
    cases = [
        ...
        ("dianping.com", "DIRECT"),
        ("p0.meituan.net", "DIRECT"),
        ("p1.meituan.net", "DIRECT"),
        ("p0.dianping.com", "DIRECT"),
        ...
        ("elenet.me", "DIRECT"),
        ("amap.com", "DIRECT"),
        ("restapi.amap.com", "DIRECT"),
        ("map.baidu.com", "DIRECT"),
        ("apis.map.qq.com", "DIRECT"),
        ("mapbar.com", "DIRECT"),
        ...
        ("h5.m.taobao.com", "DIRECT"),
        ("gw.alicdn.com", "DIRECT"),
        ("render.alipay.com", "DIRECT"),
        ("quark.cn", "DIRECT"),
        ("myquark.cn", "DIRECT"),
        ("quark.sm.cn", "DIRECT"),
        ("uczzd.cn", "DIRECT"),
    ...
    for needle, content in [
        ...
        ("DOMAIN-SUFFIX,quark.cn", shadowrocket_china),
        ("DOMAIN-SUFFIX,myquark.cn", shadowrocket_china),
        ("DOMAIN-SUFFIX,dianping.com", shadowrocket_china),
        ("DOMAIN-SUFFIX,cmbchina.com", shadowrocket_china),
        ("DOMAIN-SUFFIX,hsbc.com.cn", shadowrocket_china),
