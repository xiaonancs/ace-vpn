...
- **2026-04-17** 甲骨文 Always Free 申请教程上线（`docs/oracle-register.md`），0 元方案就位
...
- **2026-04-18** 文档瘦身：多份 00-09 doc 合并为 `docs/skill.md` + `docs/user-guide.md` 两份
...
- **2026-04-19** per-profile `dns_servers` 定向解析；修复 Clash Party GUI 吞订阅 DNS 的深坑（详见 traffic-routing-architecture.md §9.1）
- **2026-04-19** 公私仓库分离：新增 `docs/traffic-routing-architecture.md`（对外技术方案，含架构 / 流程 / 时序图）；真实配置迁入私有仓库 `ace-vpn-private`，public 仓库通过 symlink 接入
